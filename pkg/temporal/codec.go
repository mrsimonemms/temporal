...
func NewDataConverter() converter.DataConverter {
	return converter.NewCodecDataConverter(converter.GetDefaultDataConverter(), NewPayloadCodec())
}
...
func (*Codec) Decode(payloads []*common.Payload) ([]*common.Payload, error) {
...
func (e *Codec) Encode(payloads []*common.Payload) ([]*common.Payload, error) {
	result := make([]*common.Payload, len(payloads))
	for i, p := range payloads {
		// Marshal proto
